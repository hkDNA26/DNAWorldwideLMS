...
export default async function CertificatesPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold" style={{color:"var(--color-brand)"}}>My Certificates</h1>
          ...
          {certificates.map((cert) => (
            <div key={cert.id} className="bg-white rounded-xl border border-slate-200 p-6 flex flex-col">
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center gap-2 text-sm font-medium text-brand hover:text-brand-dark mt-auto"
              >
                View Certificate
